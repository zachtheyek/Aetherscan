...
| `rf_ensemble_accuracy_curve_{tag}.png` | Cumulative accuracy vs number of trees (val + train-subsample baseline). | Should saturate well before 1000 trees; if it's still climbing at the end, raise `rf.n_estimators`. |
